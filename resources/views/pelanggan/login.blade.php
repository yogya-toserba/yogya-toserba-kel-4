...
<body>
    <div class="container login-container">
        <div class="login-card">
            ...
            <div class="login-left text-center">
                ...
                <img src="{{ asset('images/shopping-illustration.png') }}" alt="Illustration" class="img-fluid" style="max-height: 300px;">
            </div>
   ...
   <form action="" method="POST">
    @csrf
    <div class="mb-3">
        <input type="text" name="username" class="form-control input" placeholder="Username" required autofocus>
    </div>
    <div class="mb-4">
...
<!-- Tombol Login Google -->
<a href="" class="btn btn-outline-danger w-100 mb-3" style="border-radius: 12px; height: 50px; padding: 10px;">
    <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google" width="24" class="me-2">
    Masuk dengan Google
</a>
