        ...
        <div class="footer-container">
            <div class="footer-content">
                <div class="footer-section">
                    <h4><i class="fas fa-info-circle"></i> Tentang Manual</h4>
                    <p>Bantuan IT My Yogya v1.0.0</p>
                    <p>Terakhir diperbarui: Agustus 2025</p>
                </div>
                <div class="footer-section">
                    <h4><i class="fas fa-phone"></i> Kontak Dukungan</h4>
                    <p>Email: it-support@myyogya.co.id</p>
                    <p>Telepon: 0800-1-YOGYA (96492)</p>
                </div>
            </div>
            <div class="footer-bottom">
                <p>&copy; 2025 My Yogya - Toserba Group. Semua hak dilindungi.</p>
            </div>
        </div>
    </footer>
