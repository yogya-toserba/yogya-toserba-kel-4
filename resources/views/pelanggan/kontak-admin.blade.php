...
<head>
    ...
    <style>
        /* Ensure FAQ styling is applied correctly */
        .faq-question {
            ...
            <div class="manual-content">
                ...
                <div id="bantuan" class="manual-section">
                    ...
                    <div class="content-card">
                        ...
                        <h3><i class="fas fa-route"></i> Alur Kontak Yang Tepat</h3>
                        ...
                        <div class="feature-grid">
                            <div class="feature-item">
                                ...
                                <h4>1. Cek FAQ Dulu</h4>
                                <p>Baca FAQ untuk jawaban cepat masalah umum</p>
                            </div>
                            <div class="feature-item">
                                <div class="feature-icon">
                                    <i class="fas fa-headset"></i>
                                ...
                                <p>Hubungi CS untuk masalah umum dan akun</p>
                            </div>
                            <div class="feature-item">
                                <div class="feature-icon">
                                    <i class="fas fa-cogs"></i>
                                ...
                                <p>Untuk masalah teknis dan sistem</p>
                            </div>
                            <div class="feature-item">
                                <div class="feature-icon">
                                    <i class="fas fa-user-shield"></i>
                                </div>
                                <h4>4. Admin Spesifik</h4>
                                <p>Hubungi admin sesuai bidang masalah</p>
                            </div>
                            <div class="feature-item">
                                <div class="feature-icon">
                                ...
                                <h4>5. Escalation</h4>
                                <p>Jika tidak terselesaikan, escalate ke level atas</p>
                            </div>
                            <div class="feature-item">
                                <div class="feature-icon">
                                    <i class="fas fa-exclamation-triangle"></i>
                                ...
                                <h4>6. Emergency</h4>
                                <p>Kontak darurat untuk masalah kritis</p>
                            </div>
                        </div>
                        ...
                        <div class="info-box info-warning">
                            ...
                            <div>
                                <h4>Penting!</h4>
                                <p>Untuk masalah yang bersifat rahasia atau sensitive, gunakan saluran aman seperti email resmi atau sistem tiket internal. Jangan bagikan informasi penting melalui chat publik.</p>
                            </div>
                        </div>
                        ...
                        <div class="info-box info-success">
                            ...
                            <div>
                                ...
                                <p>Priority High: 2-4 jam | Priority Medium: 8-24 jam | Priority Low: 1-3 hari kerja | Emergency: 15-30 menit</p>
                            </div>
                        </div>
                    </div>
                </div>
