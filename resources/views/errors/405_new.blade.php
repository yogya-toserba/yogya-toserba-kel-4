...
<head>
    ...
    <title>405 - Method Not Allowed | Yogya Toserba</title>
...
<body>
    ...
    <div class="error-container">
        <div class="error-number">405</div>
        
        <h1 class="error-title">Method Not Allowed</h1>
        <p class="error-message">
            Maaf, metode yang Anda gunakan tidak diizinkan untuk mengakses resource ini. Silakan gunakan metode yang sesuai.
        </p>
