...
@section('title', 'Data Pengawai Gudang - MyYOGYA')
...
<div class="new-pengguna">
    ...
    <div class="new-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1><i class="fas fa-warehouse me-3"></i>Data Pengawai Gudang</h1>
                <p>Manajemen Data Pengawai dan Staff Gudang MyYOGYA</p>
            </div>
    ...
    <div class="row g-4">
        <div class="col-lg-3 col-md-6">
            <div class="new-stat-card">
                ...
                <div class="new-stat-label">Total Pengawai</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="new-stat-card">
                ...
                <div class="new-stat-number">24</div>
                <div class="new-stat-label">Sedang Bertugas</div>
                <div class="new-stat-change change-positive">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="new-stat-card">
                ...
                <div class="new-stat-label">Tidak Bertugas</div>
                <div class="new-stat-change change-neutral">
                    <i class="fas fa-pause"></i> Off Duty
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="new-stat-card">
                ...
                <div class="new-stat-label">Pengawai Baru</div>
    ...
    <div class="search-filter-bar">
        <form method="GET" action="">
            <div class="row g-2 align-items-end">
                <div class="col-md-4">
                    <label for="search" class="form-label">Cari Pengawai</label>
                    <input type="text" class="form-control" id="search" name="search" 
                           placeholder="Nama, ID karyawan, nomor HP, atau posisi..." value="">
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <label for="posisi" class="form-label">Posisi Kerja</label>
        ...
        <div class="col-12">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-fallback me-3">AS</div>
                                    <div>
                                        <div class="d-flex flex-column justify-content-center">
                                            <strong>Ahmad Syahroni</strong>
                                            <small class="text-muted">ahmad.syahroni@yogya.co.id</small>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    ...
                                    <small class="text-muted">Divisi Elektronik</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    ...
                                    <small class="text-success">95% efisiensi</small>
                                </div>
                            </td>
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <small class="text-muted">siti.marlina@yogya.co.id</small>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>WH002</strong>
                                    <small class="text-muted">+62 813-5647-8901</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Quality Checker</strong>
                                    <small class="text-muted">Divisi Fashion</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Shift Siang</strong>
                                    <small class="text-muted">15:00 - 23:00</small>
                                </div>
                            </td>
                            <td>
                                <span class="badge" style="background: #dcfce7; color: #15803d; padding: 4px 8px; border-radius: 12px; font-size: 0.75rem;">Aktif</span>
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Baik</strong>
                                    <small class="text-info">88% efisiensi</small>
                                </div>
                            </td>
                            <td style="text-align: center;">
                                <button class="btn btn-sm" style="background: none; border: none; color: #64748b; padding: 4px;">
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <small class="text-muted">budi.pratama@yogya.co.id</small>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>WH003</strong>
                                    <small class="text-muted">+62 814-6758-9012</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Operator Gudang</strong>
                                    <small class="text-muted">Divisi Makanan</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Shift Malam</strong>
                                    <small class="text-muted">23:00 - 07:00</small>
                                </div>
                            </td>
                            <td>
                                <span class="badge" style="background: #fef3c7; color: #d97706; padding: 4px 8px; border-radius: 12px; font-size: 0.75rem;">Cuti</span>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Baik</strong>
                                    <small class="text-info">82% efisiensi</small>
                                </div>
                            </td>
                            <td style="text-align: center;">
                                <button class="btn btn-sm" style="background: none; border: none; color: #64748b; padding: 4px;">
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <small class="text-muted">dewi.fortuna@yogya.co.id</small>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>WH004</strong>
                                    <small class="text-muted">+62 815-7869-0123</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Admin Gudang</strong>
                                    <small class="text-muted">Divisi Kosmetik</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Sangat Baik</strong>
                                    <small class="text-success">92% efisiensi</small>
                                </div>
                            </td>
                            <td style="text-align: center;">
                                <button class="btn btn-sm" style="background: none; border: none; color: #64748b; padding: 4px;">
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <small class="text-muted">rizky.hamdani@yogya.co.id</small>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>WH005</strong>
                                    <small class="text-muted">+62 816-8970-1234</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Operator Gudang</strong>
                                    <small class="text-muted">Divisi Peralatan</small>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <span class="badge" style="background: #fee2e2; color: #dc2626; padding: 4px 8px; border-radius: 12px; font-size: 0.75rem;">Sakit</span>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Cukup</strong>
                                    <small class="text-warning">75% efisiensi</small>
                                </div>
                            </td>
                            <td style="text-align: center;">
                                <button class="btn btn-sm" style="background: none; border: none; color: #64748b; padding: 4px;">
            ...
            <div class="pagination-container">
                <div class="pagination-info">
                    Menampilkan 5 dari 28 pengawai gudang
                </div>
            ...
            <!-- Tabel Kedua: Daftar Absensi Pegawai -->
            <div class="new-card mt-4">
                <div class="new-card-header">
                    <div class="new-card-title">
                        <i class="fas fa-clipboard-list"></i>
                        Daftar Absensi Pegawai Hari Ini
                    </div>
                </div>
                <div class="new-card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('images/avatar1.jpg') }}" alt="Avatar" class="rounded-circle me-3" style="width: 40px; height: 40px; object-fit: cover;">
                                            <div>
                                                <strong>Ahmad Fadilah</strong>
                                                <br><small class="text-muted">ID: PGD-001</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>07:45</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('images/avatar2.jpg') }}" alt="Avatar" class="rounded-circle me-3" style="width: 40px; height: 40px; object-fit: cover;">
                                            <div>
                                                <strong>Siti Nurhaliza</strong>
                                                <br><small class="text-muted">ID: PGD-002</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>08:15</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('images/avatar3.jpg') }}" alt="Avatar" class="rounded-circle me-3" style="width: 40px; height: 40px; object-fit: cover;">
                                            <div>
                                                <strong>Budi Santoso</strong>
                                                <br><small class="text-muted">ID: PGD-003</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>-</td>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <span class="badge" style="background: #fee2e2; color: #dc2626; padding: 4px 8px; border-radius: 12px; font-size: 0.75rem;">Tidak Hadir</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <!-- Tabel Ketiga: Evaluasi Kinerja Pegawai -->
            <div class="new-card mt-4">
                <div class="new-card-header">
                    <div class="new-card-title">
                        <i class="fas fa-star"></i>
                        Evaluasi Kinerja Pegawai Bulan Ini
                    </div>
                </div>
                <div class="new-card-body">
                    <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>Ahmad Fadilah</strong>
                                                <br><small class="text-muted">Supervisor</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>1000 unit</td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            ...
                                            <small class="text-muted">Melebihi target</small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>Siti Nurhaliza</strong>
                                                <br><small class="text-muted">Staff Gudang</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>800 unit</td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <strong class="text-warning">90%</strong>
                                            <small class="text-muted">Hampir target</small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td>
                                        <strong class="text-primary">Rp 200.000</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            ...
                                            <small class="text-muted">Kurang target</small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
