    ...
    <div class="row g-4">
        <div class="col-lg-3 col-md-6">
            <div class="new-stat-card">
                ...
                <div class="new-stat-number">{{ $totalPengguna ?? 0 }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="new-stat-card">
                ...
                <div class="new-stat-number">{{ $penggunaAktif ?? 0 }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="new-stat-card">
                ...
                <div class="new-stat-number">{{ $totalPengguna - $penggunaAktif }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="new-stat-card">
                ...
                <div class="new-stat-number">{{ $penggunaBulanIni ?? 0 }}</div>
                ...
                <div class="new-card-body">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div style="width: 35px; height: 35px; background: linear-gradient(135deg, #f26b37 0%, #e55827 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; margin-right: 10px;">
                                                {{ strtoupper(substr($customer->nama, 0, 2)) }}
                                            </div>
                                            <div>
                                                <strong>{{ $customer->nama }}</strong>
                                                <br><small>{{ $customer->email ?? 'Tidak ada email' }}</small>
                                                <br><small>HP: {{ $customer->telepon ?? 'Tidak ada HP' }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge" style="background: #dbeafe; color: #1d4ed8; padding: 4px 8px; border-radius: 12px; font-size: 0.75rem;">Regular</span>
                                    </td>
                                    <td>
                                        <strong>{{ $customer->alamat ?? 'Tidak diketahui' }}</strong>
                                    ...
                                    <td>
                                        <strong>{{ $customer->updated_at ? $customer->updated_at->diffForHumans() : '-' }}</strong>
                                        <br><small>{{ $customer->updated_at ? $customer->updated_at->format('H:i') : '-' }} WIB</small>
                                    </td>
                                    <td>
                                        <strong>{{ $customer->created_at->diffForHumans() }}</strong>
                                    </td>
                    ...
                    <div class="pagination-container">
                        <div class="pagination-info">
                            Menampilkan {{ $pelanggan->firstItem() ?? 0 }} sampai {{ $pelanggan->lastItem() ?? 0 }} dari {{ $pelanggan->total() ?? 0 }} pembeli
                        </div>
