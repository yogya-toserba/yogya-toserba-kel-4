            ...
            <div class="row g-2 align-items-end">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="search" name="search" 
                           placeholder="Nama transaksi, ID laporan, atau kategori..." value="">
                </div>
                <div class="col-md-2">
                ...
                <div class="new-card-body">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-fallback me-3">RP</div>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    ...
                                    <small class="text-info">Dalam batas budget</small>
                                </div>
                            </td>
                            <td>
                                <button class="btn-menu">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge" style="background: #fef3c7; color: #d97706; padding: 4px 8px; border-radius: 12px; font-size: 0.75rem;">Review</span>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <strong>Rp 700.000</strong>
                                    <small class="text-warning">Dalam review</small>
                                </div>
                            </td>
                            <td>
                                <button class="btn-menu">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-fallback me-3">AT</div>
                                    <div>
                                        <div class="d-flex flex-column justify-content-center">
                                            <strong>Laporan Aset</strong>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    ...
                                    <small class="text-success">Nilai aset stabil</small>
                                </div>
                            </td>
                            <td>
                                <button class="btn-menu">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge" style="background: #fee2e2; color: #dc2626; padding: 4px 8px; border-radius: 12px; font-size: 0.75rem;">Pending</span>
                            </td>
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                    ...
                    <div class="pagination-container">
                        <div class="pagination-info">
                            Menampilkan 5 dari 248 laporan keuangan
                        </div>
