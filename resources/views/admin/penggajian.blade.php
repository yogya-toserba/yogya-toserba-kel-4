...
@section('content')
    <style>
        ...
        * {
        ...
        body.dark-mode .badge[style*="color:"] {
            opacity: 1 !important;
            visibility: visible !important;
        }
                                ...
                                <table class="table table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-header-cell" style="font-size: 0.75rem; text-align: center;">
                                                Karyawan</th>
                                            <th class="table-header-cell" style="font-size: 0.75rem; text-align: center;">
                                                Status</th>
                                        </tr>
                                        ...
                                        <tr class="table-row">
                                            ...
                                            <td class="table-data-cell" style="text-align: center;">
                                                <span class="badge-paid"
                                                    style="font-size: 0.65rem; padding: 4px 10px;">SELESAI</span>
                                            </td>
                                        </tr>
                                        <tr class="table-row">
                                            <td class="table-data-cell">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">Solo
                                                </div>
                                            ...
                                            <td class="table-data-cell" style="text-align: center;">
                                                <span class="badge-pending"
                                                    style="font-size: 0.65rem; padding: 4px 10px;">MENUNGGU</span>
                                            </td>
                                        </tr>
                                        <tr class="table-row">
                                            <td class="table-data-cell">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">Semarang
                                                </div>
                                                <small style="color: #64748b; font-size: 0.7rem;">Cabang</small>
                                            </td>
                                            <td class="table-data-cell" style="text-align: center;">
                                            ...
                                            <td class="table-data-cell" style="text-align: center;">
                                                <span class="badge-process"
                                                    style="font-size: 0.65rem; padding: 4px 10px;">DIPROSES</span>
                                            </td>
                                        </tr>
                                        <tr class="table-row">
                                            <td class="table-data-cell">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">Magelang
                                                </div>
                                                <small style="color: #64748b; font-size: 0.7rem;">Cabang</small>
                                            </td>
                                            <td class="table-data-cell" style="text-align: center;">
                ...
                <div class="new-card table-card">
                    ...
                    <div class="new-card-body">
                        <div class="table-content">
                            <div class="table-responsive">
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        <tr class="table-row">
                                            <td class="table-data-cell">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">31 Ags
                                                </div>
                                                <small style="color: #64748b; font-size: 0.7rem;">09:15</small>
                                            </td>
                                            <td class="table-data-cell" style="text-align: center;">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">#AGS001
                                                </div>
                                                <small style="color: #64748b; font-size: 0.7rem;">127 org</small>
                                            </td>
                                            <td class="table-data-cell" style="text-align: center;">
                                                <span class="badge-paid"
                                                    style="font-size: 0.65rem; padding: 4px 10px;">BERHASIL</span>
                                            </td>
                                        </tr>
                                        <tr class="table-row">
                                            <td class="table-data-cell">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">30 Ags
                                                </div>
                                                <small style="color: #64748b; font-size: 0.7rem;">14:30</small>
                                            </td>
                                            <td class="table-data-cell" style="text-align: center;">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">#AGS002
                                                </div>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-data-cell">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">29 Ags
                                                </div>
                                                <small style="color: #64748b; font-size: 0.7rem;">16:45</small>
                                            </td>
                                            <td class="table-data-cell" style="text-align: center;">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">#AGS003
                                                </div>
                                        ...
                                        <tr class="table-row">
                                            <td class="table-data-cell">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">28 Ags
                                                </div>
                                                <small style="color: #64748b; font-size: 0.7rem;">11:20</small>
                                            </td>
                                            <td class="table-data-cell" style="text-align: center;">
                                                <div style="font-weight: 600; color: #1f2937; font-size: 0.8rem;">#AGS004
                                                </div>
                            ...
                            <div class="summary-section">
                                <button class="btn btn-modern btn-header w-100"
    ...
    `;
        ...
        function updateSelectAllState() {
            ...
            selectAllCheckbox.indeterminate = checkedBoxes.length > 0 && checkedBoxes.length < rowCheckboxes
                .length;
        }
        ...
        window.bulkAction = function(action) {
            ...
            if (action === 'delete') {
                if (!confirm('Apakah Anda yakin ingin menghapus ' + checkedBoxes.length +
                        ' data gaji yang dipilih?')) {
                    return;
                }
            }
        ...
        window.selectAllAndAction = function(action) {
        ...
        if (action === 'approve') {
            alert('Fitur approve akan segera tersedia!');
        } else if (action === 'process') {
            alert('Fitur proses pembayaran akan segera tersedia!');
        }
        };
        });
    </script>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateBulkActionsVisibility() {
                const checkedBoxes = document.querySelectorAll('tbody input[type="checkbox"]:checked');
                const bulkActions = document.querySelector('.card .card-body');
