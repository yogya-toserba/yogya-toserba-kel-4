...
@section('title', 'Kesehatan & Kecantikan - Yogya Toserba')
    ...
    <div class="mb-8">
        <nav class="text-sm breadcrumbs mb-4">
            <ul class="flex space-x-2 text-gray-600">
                ...
                <li class="before:content-['/'] before:mx-2">Kesehatan & Kecantikan</li>
            </ul>
        </nav>
        
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Kesehatan & Kecantikan</h1>
        <p class="text-gray-600">Produk kesehatan dan kecantikan untuk mendukung gaya hidup sehat</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        @foreach([
            [
                ...
                'discount' => '11%',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Vitamin+C',
                'rating' => 4.7,
                'reviews' => 234
            ],
            [
                ...
                'original_price' => '',
                'discount' => '',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Skincare+Set',
                'rating' => 4.8,
                'reviews' => 156
            ],
            [
                'name' => 'Masker Wajah Collagen 10 Pcs',
                'price' => 'Rp 45.000',
                'original_price' => 'Rp 55.000',
                'discount' => '18%',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Face+Mask',
                'rating' => 4.6,
                'reviews' => 89
            ]
        ] as $product)
