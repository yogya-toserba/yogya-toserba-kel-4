...
@section('title', 'Perawatan Pribadi - Yogya Toserba')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <nav class="text-sm breadcrumbs mb-4">
            <ul class="flex space-x-2 text-gray-600">
                ...
                <li class="before:content-['/'] before:mx-2">Perawatan Pribadi</li>
            </ul>
        </nav>
        
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Perawatan Pribadi</h1>
        <p class="text-gray-600">Produk perawatan pribadi untuk kesehatan dan kebersihan sehari-hari</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        @foreach([
            [
                'name' => 'Shampoo Anti Ketombe 400ml',
                'price' => 'Rp 45.000',
                'original_price' => 'Rp 55.000',
                'discount' => '18%',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Shampoo',
                'rating' => 4.6,
                'reviews' => 234
            ],
            [
                'name' => 'Body Lotion Vitamin E 250ml',
                'price' => 'Rp 35.000',
                'original_price' => '',
                'discount' => '',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Body+Lotion',
                'rating' => 4.7,
                'reviews' => 189
            ],
            [
                'name' => 'Pasta Gigi Herbal 150g',
                'price' => 'Rp 12.500',
                'original_price' => 'Rp 15.000',
                'discount' => '17%',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Pasta+Gigi',
                'rating' => 4.5,
                'reviews' => 156
            ],
            [
                'name' => 'Facial Wash Oil Control 100ml',
                'price' => 'Rp 28.000',
                'original_price' => '',
                'discount' => '',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Facial+Wash',
                'rating' => 4.8,
                'reviews' => 267
            ],
            [
                'name' => 'Deodoran Spray 150ml',
                'price' => 'Rp 22.000',
                'original_price' => 'Rp 28.000',
                'discount' => '21%',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Deodoran',
                'rating' => 4.4,
                'reviews' => 134
            ],
            [
                ...
                'original_price' => '',
                'discount' => '',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Baby+Oil',
                'rating' => 4.6,
                'reviews' => 98
            ]
        ] as $product)
