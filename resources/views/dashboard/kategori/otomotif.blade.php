...
@section('title', 'Otomotif - Yogya Toserba')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <nav class="text-sm breadcrumbs mb-4">
            <ul class="flex space-x-2 text-gray-600">
                ...
                <li class="before:content-['/'] before:mx-2">Otomotif</li>
            </ul>
        </nav>
        
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Otomotif</h1>
        <p class="text-gray-600">Perlengkapan dan aksesoris otomotif untuk kendaraan Anda</p>
    </div>
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="flex flex-wrap items-center gap-4">
                <select class="border border-gray-300 rounded-lg px-3 py-2 text-sm">
                    ...
                    <option>Aksesoris Interior</option>
                    <option>Aksesoris Eksterior</option>
                    <option>Perawatan Mobil</option>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        @foreach([
            [
                'name' => 'Oli Mesin Synthetic 5W-30 4L',
                'price' => 'Rp 189.000',
                'original_price' => 'Rp 220.000',
                'discount' => '14%',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Oli+Mesin',
                'rating' => 4.7,
                'reviews' => 234
            ],
            [
                'name' => 'Ban Radial 185/65 R15',
                'price' => 'Rp 459.000',
                'original_price' => '',
                'discount' => '',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Ban+Mobil',
                'rating' => 4.6,
                'reviews' => 156
            ],
            [
                'name' => 'Car Wax Premium 300ml',
                'price' => 'Rp 65.000',
                'original_price' => 'Rp 85.000',
                'discount' => '24%',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Car+Wax',
                'rating' => 4.5,
                'reviews' => 89
            ],
            [
                'name' => 'Karpet Mobil Universal',
                'price' => 'Rp 125.000',
                'original_price' => '',
                'discount' => '',
            ...
            [
                'name' => 'Aki Mobil 12V 45Ah',
                'price' => 'Rp 389.000',
                'original_price' => 'Rp 450.000',
                'discount' => '14%',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Aki+Mobil',
                'rating' => 4.8,
                'reviews' => 145
            ],
            [
                'name' => 'Parfum Mobil Lavender',
                'price' => 'Rp 25.000',
                'original_price' => '',
                'discount' => '',
                'image' => 'https://via.placeholder.com/300x300/f0f0f0/888?text=Parfum+Mobil',
                'rating' => 4.3,
                'reviews' => 78
            ]
        ] as $product)
