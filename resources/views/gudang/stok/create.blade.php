...
@section('title', 'Tambah Stok - {{ $gudang->nama_gudang }}')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-semibold">Tambah Produk Stok</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('gudang.stok.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
